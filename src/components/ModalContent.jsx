export default function ModalContent({ country, closeModal }) {
  ...
  return (
    <div
      onClick={closeModal}
      className='fixed z-10 top-0 left-0 w-full h-full backdrop-blur-sm bg-black/50  flex justify-center items-center '
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className='min-w-[500px] relative rounded p-7 backdrop-blur-sm bg-white/80'
      >
        <button
          onClick={closeModal}
        ...
        <p className='text-lg mb-2'>
          <span className='font-semibold'>Continent</span> : {country.region}
        </p>
        <p className='text-lg mb-2'>
